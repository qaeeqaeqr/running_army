...
class Mainpage(object):
    def __init__(self):
        ...
        self.button_start_untouched.y = self.button_start_touched.y = 300
        ...
        self.button_setting_untouched.y = self.button_setting_touched.y = 400
        self.is_button_setting_touch = False

        self.button_quit_untouched = Actor('button_untouched')
        self.button_quit_touched = Actor('button_touched')
        self.button_quit_untouched.x = self.button_quit_touched.x = 200
        self.button_quit_untouched.y = self.button_quit_touched.y = 500
        self.is_button_quit_touch = False
    ...
    def draw(self, screen):
        ...
        if self.is_button_quit_touch:
            self.button_quit_touched.draw()
        else:
            self.button_quit_untouched.draw()
        screen.draw.text('quit', (self.button_quit_touched.x - 36, self.button_quit_touched.y - 16),
                         fontsize=50, color=(20, 220, 20))
    ...
    def on_mouse_move(self, pos, rel):
        ...
        if self.button_quit_untouched.collidepoint(pos[0], pos[1]):
            self.is_button_quit_touch = True
        else:
            self.is_button_quit_touch = False
    ...
    def on_mouse_down(self, pos, button):
        ...
        if self.button_setting_untouched.collidepoint(pos[0], pos[1]) and button == mouse.LEFT:
            return 'setting'
        if self.button_quit_untouched.collidepoint(pos[0], pos[1]) and button == mouse.LEFT:
            sys.exit()
